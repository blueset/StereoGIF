...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference("pref_GIF_delay"));
        bindPreferenceSummaryToValue(findPreference("pref_GIF_size"));
        bindPreferenceSummaryToValue(findPreference("pref_GIF_quality"));
        /*
